        ...
        <div className="self-auto">
            <div className="lg:max-w-xs bg-white shadow-sm rounded-xl p-1">
                ...
                <div className="text-sm bg-gray-50 rounded-lg p-5 m-1">
                    A longer paragraph about your background, what you enjoy working on, and how you like to collaborate. Replace this text with your own story.
                    <hr className="my-5 border-gray-200"></hr>
                    <div className="flex flex-col gap-2 font-medium">
                        <a href="https://github.com/your-username" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-3 py-2 -mx-3 rounded-lg hover:bg-gray-100 transition-colors group">
                        ...
                        <a href="https://www.linkedin.com/in/your-profile/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-3 py-2 -mx-3 rounded-lg hover:bg-gray-100 transition-colors group">
