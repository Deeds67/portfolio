...
const AboutMe = (props: Props) => {
    ...
    return (
        <div className="flex flex-col max-w-xs bg-white rounded-xl p-2 gap-4">
        <p className="font-semibold pl-5 text-lg">Pierre Marais</p>
        <p className="pl-5">Senior Software Engineer - DE</p>
        ...
        <Button className="flex justify-center items-center gap-3 w-auto text-white bg-blue-600 hover:bg-blue-500 ring-offset-2 ring-blue-600 focus:ring shadow rounded-lg">
            Download CV
